[![Build Status](https://dev.azure.com/manishpanwar1/python-flask/_apis/build/status%2Fpython-flask?branchName=main)](https://dev.azure.com/manishpanwar1/python-flask/_build/latest?definitionId=11&branchName=main)
